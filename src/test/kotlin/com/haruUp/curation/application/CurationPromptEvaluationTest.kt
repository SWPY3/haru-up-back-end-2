...
class CurationPromptEvaluationTest {
    ...
    private val personas = listOf(
        ...
        Persona(
            key = "bodyprofile",
            category = "운동 · 바디프로필",
            goalText = "6개월 뒤 바디프로필 촬영하기",
            profile = """
                28세 사무직 여성. 키 163cm, 몸무게 62kg, 체지방률 30% 정도로 알고 있다.
                주 2회 헬스장에 가서 러닝머신 30분만 걷다 오고, 웨이트는 기구 사용법을 몰라 손대지 못한다.
                평일 저녁 8시쯤 퇴근하고, 단백질 위주 식단은 한 번도 해본 적이 없다.
                촬영 스튜디오는 아직 예약하지 않았고, 어깨와 등 라인을 가장 만들고 싶어한다.
            """.trimIndent()
        ),
        Persona(
            key = "english-travel",
            category = "영어 회화 · 해외여행",
            goalText = "해외여행에서 영어로 대화하기",
            profile = """
                35세 직장인 남성. 올해 겨울 유럽 배낭여행을 계획하고 있다.
                토익 780점이지만 말하기는 거의 못 한다. 외국인이 말을 걸면 단어만 겨우 내뱉는 수준이다.
                해외여행은 일본만 두 번 가봤고, 그때는 번역 앱으로만 해결했다.
                공항 체크인, 호텔 체크인, 식당 주문에서 막히는 것이 가장 두렵다고 생각한다.
                출퇴근은 지하철로 편도 40분이고, 회화 학원은 시간이 맞지 않아 다니지 못한다.
            """.trimIndent()
        ),
        Persona(
            key = "stock-income",
            category = "주식 투자 · 수익 창출",
            goalText = "주식 투자로 월 50만원 수익 내기",
            profile = """
                33세 직장인 남성. 투자 경험 2년, 현재 투자금 3000만원.
                국내 대형주 위주로 5종목을 들고 있고, 매수 근거는 대부분 뉴스와 유튜브였다.
                재무제표에서 매출과 영업이익 정도만 볼 줄 알고 PER·PBR은 개념만 안다.
                지난해 수익률은 마이너스 8%였고, 손절 기준을 정해두지 않아 물타기를 반복했다.
                평일 근무 중에는 매매가 어렵고 장 마감 후에만 시세를 확인한다.
            """.trimIndent()
        ),
        Persona(
            key = "quit-smoking",

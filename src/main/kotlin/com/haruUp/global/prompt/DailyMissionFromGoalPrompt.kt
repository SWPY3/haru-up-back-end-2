...
- description (반드시 공백 포함 20자 이상 30자 이내): 구체적 실행 방법.
  ...
  좋은 예) "유튜브 토익 LC 강의 1편 보고 핵심 패턴 5개 메모하기" (모두 포함, 20자 이상)
  나쁜 예) "한달 20거래일 기준 계산" (13자, 20자 미만 + 방법/수치 없음 - 절대 금지)
  20자 미만 description이 하나라도 있으면 응답 전체가 폐기되고 재생성됩니다.
...
- 총 15개인가?
- 모든 description이 공백 포함 20자 이상 30자 이내인가? (글자수를 직접 세어 확인하고, 미달이면 방법·수치를 추가해 다시 작성)
5+5+5=15개가 아니거나 20자 미만 description이 있으면 수정 후 출력하세요.

...
- 출력 전에 brief의 글자 수를 공백까지 세어 확인하세요. 80자를 넘으면 문장을 자르지 말고 처음부터 다시 쓰세요.
- 80자를 넘기는 원인은 대부분 대화에 나온 수치를 전부 담으려는 것입니다.
  목표와 가장 가까운 수치 1~2개만 남기고 나머지는 버리세요. (버린 정보는 detailed에 이미 들어 있습니다.)
  나쁜 예) "6개월 뒤 바디프로필 촬영이 목표이고, 현재 체지방률은 약 30%예요. 어깨·등 라인을 살린 건강하고 여성스러운 분위기를 원하고, 운동은 주 2회 러닝머신 30분 정도예요." (96자, 3문장 - 절대 금지)
    → 고친 예) "6개월 뒤 바디프로필이 목표이고, 현재 체지방률 30%에서 어깨·등 라인을 만들고 싶어요." (50자)
